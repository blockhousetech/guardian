...
static sgx_status_t SGX_CDECL sgx_ecall_tbtl(void* pms)
{
	CHECK_REF_POINTER(pms, sizeof(ms_ecall_tbtl_t));
	//
	// fence after pointer checks
	//
	sgx_lfence();
	ms_ecall_tbtl_t* ms = SGX_CAST(ms_ecall_tbtl_t*, pms);
...
SGX_EXTERNC const struct {
	...
	1,
	{
		{(void*)(uintptr_t)sgx_ecall_tbtl, 0, 0},
	}
};
