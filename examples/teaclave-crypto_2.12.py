...
enclave_path = "examples/teaclave-crypto_2.12/enclave.signed.so"

# setup angr and guardian projects
proj = angr.Project(enclave_path)
guard = guardian.Project(proj, teaclave=True)
guard.set_target_ecall(0x5)  # set target ecall
...
enclave_path = "examples/teaclave-crypto_2.12/enclave-after-fix.signed.so"
