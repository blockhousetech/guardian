...
enclave_path = "examples/teaclave-sealeddata_2.12/enclave.signed.so"

# setup angr and guardian projects
proj = angr.Project(enclave_path)
guard = guardian.Project(proj, teaclave=True)
guard.set_target_ecall(0x4)  # set target ecall
...
enclave_path = "examples/teaclave-sealeddata_2.12/enclave-after-fix.signed.so"
